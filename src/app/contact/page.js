        ...
        <section className="section-shell contact-shell">
          <div className="contact-intro">
            ...
            <div className="contact-details">
              <a href="mailto:yozukakit@gmail.com"><FiMail aria-hidden="true" /><span><small>Email</small>yozukakit@gmail.com</span><FiArrowUpRight aria-hidden="true" /></a>
          ...
          <div className="contact-form-wrap">
            ...
            <form className="contact-form" action="mailto:yozukakit@gmail.com" method="post" encType="text/plain">
