            ...
            const timeoutPromise = new Promise((_, reject) => {
                setTimeout(
                    () =>
                        reject(
                            new Error(
                                "Request timeout. Periksa koneksi internet atau Supabase URL."
                            )
                        ),
                    10000
                );
            ...
            >
                ...
                <div className="auth-content">
                    <div className="auth-copy">
                        ...
                        <p>
                            Kelola project dan konten portfolio Achmad
                            Aldino dari satu tempat.
                        </p>
                    </div>
                    ...
                    <div className="auth-card">
                        ...
                        <p className="auth-note">
                            Akses ini hanya untuk pengelolaan
                            portfolio.
                        </p>
                    </div>
                </div>
                ...
                <Link href="/">
                    <FiArrowUpRight aria-hidden="true" /> Kembali ke
                    portfolio
                </Link>
            </section>
        </main>
